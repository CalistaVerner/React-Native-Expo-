export const ru = {
  ...
  common: {
    ...
    sessionOpenedSuffix: 'Готово к воспроизведению.',
  ...
  player: {
    nowPlayingEyebrow: 'Сейчас играет',
    continueListening: 'Продолжить практику',
    emptyTitle: 'Сессия ещё не выбрана',
    emptyText: 'Откройте медитацию из библиотеки, и runtime плеера подготовит трек здесь.',
    open: 'Открыть плеер',
    close: 'Закрыть плеер',
    next: 'Далее',
    upNext: 'Следом',
    demoStatus: 'Сейчас воспроизведение симулируется внутри переиспользуемого runtime плеера. Реальный audio backend можно подключить следующим шагом без переписывания UI-слоя.',
  },
  moods: {
    calm: 'Спокойно',
    neutral: 'Нормально',

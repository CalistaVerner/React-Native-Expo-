export const en = {
  ...
  common: {
    ...
    sessionOpenedSuffix: 'Ready for playback.',
  ...
  player: {
    ...
    emptyTitle: 'No session selected yet',
    emptyText: 'Open a meditation from the library and the player runtime will prepare the track here.',
    open: 'Open player',
    close: 'Close player',
    next: 'Next',
    upNext: 'Up next',
    demoStatus: 'Playback is currently simulated inside the reusable player runtime. The real audio backend can be connected next without rewriting the UI layer.',
  },
  moods: {
    calm: 'Calm',
    neutral: 'Okay',
